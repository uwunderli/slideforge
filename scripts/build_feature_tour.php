...
function tourStrings(): array
{
    ...
    return [
        'de' => [
            ...
            'tpl_body' => "- **Folienvorlagen** und Textstile\n- **Markenfarbpalette** (editierbar)\n- **Pixabay** für Stock-Medien (optional)\n- **Iconify**-Icons und **Openclipart**-Cliparts (ohne API-Key)\n- **WebDAV** — eigene Cloud-/NAS-Medien im Profil verbinden\n- **Hintergrund entfernen** bei Bildern",
        ...
        'fr' => [
            ...
            'tpl_body' => "- **Modèles de diapos** et styles de texte\n- **Couleurs de marque** éditables\n- Médias **Pixabay** (optionnel)\n- Icônes **Iconify** et cliparts **Openclipart** (sans clé API)\n- **WebDAV** — vos médias cloud/NAS via le profil\n- **Supprimer l'arrière-plan** sur les images",
