# SlideForge – Release v2.4.0 (Briefing)

> **Handoff:** *„Lies `docs/RELEASE_v2.4.0.md` und setze die Release um — ausser „Nicht in dieser Release“.“*

Stand: Juli 2026 · Basis: **v2.3.0** (main)
...
| **Nicht** | Kein Auto-Animate über vertikale (verschachtelte) Folien in v2.4.0 |
...
| 2 | Pfad entlang Kurve? | **Nicht in v2.4.0 MUSS** (NICE / später) | Auto-Animate interpoliert linear/transform-basiert; Kurvenpfade wären Custom-Feature. |
