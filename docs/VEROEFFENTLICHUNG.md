...
| GitHub / Releases | [github.com/uwunderli/slideforge](https://github.com/uwunderli/slideforge) · aktuell **v2.1.0** |
...
- [x] Releases bis **v2.1.0** (Mobile, PWA, Folien-Sets & Logos-Import)
...
**Nur Tag zu GitHub (ohne Deploy):** `git push origin vX.Y.Z` — der Hook erkennt Tag-only und überspringt Prod/Demo.
