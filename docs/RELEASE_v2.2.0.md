# SlideForge – Release v2.2.0 (Briefing)

> **Handoff:** In einem neuen Cursor-Chat:
> *„Lies `docs/RELEASE_v2.2.0.md` und setze die Release um — ausser „Nicht in dieser Release“.“*

Stand: Juli 2026 · Basis: **v2.1.0** (main)
...
| **Nicht** | Kein Schnitt auf mehrere Clips; kein Audio-Mixing; kein Frame-genaues Keyframe-Editing; **kein FFmpeg** in v2.2.0 |
