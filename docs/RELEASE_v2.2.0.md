...
Stand: Juli 2026 · Basis: **v2.1.3** · **Integration:** [church.tools](https://church.tools)
...
- [ ] i18n · PR → main · Tag **`v2.2.0`** · Deploy
...
| 4 | Version | **v2.2.0** (Integration) | church.tools in v2.x-Reihe, nach Folien-Sets v2.1; vor Editor-Major v3.1. |
