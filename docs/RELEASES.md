...
| **3** | **v2.2.0** | **church.tools** — Live-Kalender, Gruppen, Platzhalter-Templates | ✅ Briefing fertig · **nächster Major nach 2.1.8** | [RELEASE_v2.2.0.md](RELEASE_v2.2.0.md) |
...
| Lage | Stand |
|------|--------|
| **Letzter Tag** | **v2.1.8** auf GitHub / `main` |
