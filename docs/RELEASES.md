...
Übersicht aller geplanten Releases. Nach **v1.0.4** folgt die **v2.x**-Linie; der slides.com-Editor wird **v3.0.0**.
...
| **5** | **v3.0.0** | **Editor v2** — slides.com-artiger visueller Editor (Major) | ✅ Briefing fertig | [RELEASE_v3.0.0.md](RELEASE_v3.0.0.md) |
...
| **v2.x** | Mobile, church.tools, Medien-Editor, Auto-Animate |
| **v3.0** | Neuer visueller Editor (slides.com), Konva bleibt als „Klassischer Editor“ |
